const pistas = [
  ...
  },
  {
    ...
    peso: 6,
    celula: { x: 2, y: 7 },
    localizacao: '(2,7) Quarto de Hóspedes',
    categoria: 'documento',
    encontrada: false,
    dataDescoberta: null
  },
  {
    ...
    peso: 5,
    celula: { x: 5, y: 3 },
    localizacao: '(5,3) Sala de Jantar',
    categoria: 'evidencia_fisica',
    encontrada: false,
    dataDescoberta: null
  },
  ...
  },
  {
    ...
    peso: 9,
    celula: { x: 6, y: 9 },
    localizacao: '(6,9) Quarto do Guarda',
    categoria: 'evidencia_fisica',
    encontrada: false,
    dataDescoberta: null
  },
  {
    ...
    peso: 6,
    celula: { x: 3, y: 0 },
    localizacao: '(3,0) Biblioteca - Segundo Andar',
    categoria: 'documento',
    encontrada: false,
    dataDescoberta: null
  }
